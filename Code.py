# -*- coding: utf-8 -*-
"""
Created on Sat Sep 18 12:54:41 2021
...
class Block():
    ...
    def build_block(self):
        ...
        '''
        np.flipud() will flip the block. This is done because in default indexing (0,0) starts at the 
        top left corner of a matrix whereas the question requires (0,0) to be at the bottom left corner.
        '''
